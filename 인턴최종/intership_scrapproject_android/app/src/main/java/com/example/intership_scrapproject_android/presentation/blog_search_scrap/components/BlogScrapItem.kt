...
fun BlogScrapItem(
    ...
    Box (
        modifier = modifier
            .fillMaxSize()
            .testTag(TestTags.blogScrapItem)
    ){
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            Row {
                ...
                Text(
                    modifier = Modifier.testTag(TestTags.blogScrapItemKeyword),
                    text = keyword,
            ...
            TextField(
                modifier = Modifier
                    .fillMaxWidth()
                    .testTag(TestTags.blogScrapItemTitle)
                ,
                value = title,
            ...
            TextField(
                modifier = Modifier
                    .fillMaxWidth()
                    .testTag(TestTags.blogScrapItemDescription)
                ,
                value = description,
